export default function Sidebar() {
  return (
    <aside className="sidebar">
      <img
        src="https://github.com/RahulDwivedi205.png"
        alt="Profile"
        className="sidebar-avatar"
      />
      <h1 className="sidebar-name">Rahul Kumar Dwivedi</h1>
      <p className="sidebar-username">RahulDwivedi205</p>
      ...
      <div className="sidebar-socials">
        ...
        <a
          href="https://www.linkedin.com/in/rahul-dwivedi-69a449292/"
          target="_blank"
          rel="noreferrer"
          className="sidebar-social-btn"
        >
